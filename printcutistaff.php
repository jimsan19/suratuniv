...
$conn = mysqli_connect('localhost','root','','suratuniv');
   ...
   if(isset($_GET['idcuti'])){
    $idcuti    = $_GET['idcuti'];
     ...
     $query = mysqli_query($conn,"SELECT * FROM  suratcutistaff INNER JOIN dosen ON suratcutistaff.nip = dosen.nip INNER JOIN fakultas ON suratcutistaff.idfak = fakultas.idfak  AND idcuti=".$idcuti);
         $no = 1;
...
<span style="font-size: x-small;">Hormat Saya,  </span></div><br><br><br>
<div align="center">
<span style="font-size: x-small;">Ir. Tahir  </span></div>
<div align="center">
<span style="font-size: x-small;">NIP 196602231994011001 </span></div>
</td>
</tr>
</table>
...
<table align="center" border="0" cellpadding="3" style="width: 550px;"><tbody>   
<tr>    
     <td>
