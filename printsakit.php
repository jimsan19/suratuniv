 ...
 ">
                              <div align="center">
                                  ...
                                  <span style="font-family: Verdana; font-size: 12px;">KEMENTRIAN PENDIDIKAN, KEBUDAYAAN, RISET DAN TEKNOLOGI</span><br>
                      ...
                      <tr>
                          <td colspan="2">
                              <table border="0" cellpadding="1" style="width: 100%;">
                                  <tbody>
                                      <tr>
                                          <td width=""><span style="font-size: x-small;">No</span></td>
                                          <td width=""><span style="font-size: x-small;">:</span></td>
                                          <td></td>
                                          <td></td>
                                          <td width=""><span style="font-size: x-small;"><?= $result['nocut'] ?></span></td>
                                      </tr>
                                      <td></td>
                                      <td></td>
                                      <td></td>
              ...
              <table style='width:550px; font-size:8pt; font-family:calibri; border-collapse: collapse;' border='0'>
                      ...
                      <tr>
                          ...
                          <td valign="top">
                              ...
                              <div align="center">
                                  ...
                                  <span style="font-size: x-small;">NIP. <?= $result['nip'] ?> </span>
                              </div>
                          </td>
                      </tr>
                  </table>
                  ...
                  <table align="center" border="0" cellpadding="3" style="width: 700px;">
                      <tbody>
                          <tr>
                              <td>
