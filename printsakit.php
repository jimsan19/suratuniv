...
$con = mysqli_connect('localhost','root','','suratuniv');
   ...
   if(isset($_GET['idsakit'])){
    $idsakit    = $_GET['idsakit'];
   
     $query = mysqli_query($con,"SELECT * FROM  suratsakit INNER JOIN dosen ON suratsakit.nip = dosen.nip INNER JOIN fakultas ON suratsakit.idfak = fakultas.idfak AND idsakit=".$idsakit);
         $no = 1;
...
<tr>          <td width="93"><span style="font-size: x-small;">No</span></td>  
       <td width="8"><span style="font-size: x-small;">:</span></td>   <td></td>
         <td></td>
             <td width="200"><span style="font-size: x-small;"><?=$result['nocut']?></span></td> 
                </tr>
               <td></td> 
               <td></td> 
               <td></td> 
...
<tr>
    ...
    <tr> <td></td><td></td> <td></td> <td></td>    <td></td><td></td> <td></td> <td></td> <td></td>   
            <td width="200" class=""><span style="font-size: x-small;">Yth. Dekan <?=$result['namafak']?></td>  </tr>
              <tr><td></td> <td></td> <td></td> <td></td> <td></td> <td></td> <td></td> <td></td> <td></td>  <td width="200"><span style="font-size: x-small;">di</td> </tr>
                 <tr><td></td> <td></td> <td></td> <td></td> <td></td> <td></td> <td></td> <td></td> <td></td>  <td width="200"><span style="font-size: x-small;">Tempat</td> </tr>
...
<span style="font-size: x-small;">Hormat Saya,  </span></div><br><br><br>
<div align="center">
<span style="font-size: x-small;"><?=$result['nama']?> </span></div></td>
</tr>
</table>
...
<span style="font-size: x-small;">Hormat Saya,  </span></div><br><br><br>
<div align="center">
<span style="font-size: x-small;">Anjar Pradipta, S.kom., M.Kom  </span></div>
<div align="center">
<span style="font-size: x-small;">NIP 199407082022031012 </span></div>
</td>
</tr>
</table>
...
<tr>
    <td ></td>
    <td></td>
    <td  height="80px"  valign="top"><div align="center"><br><br><br><br>
...
<table align="center" border="0" cellpadding="3" style="width: 700px;"><tbody>   
<tr>    
     <td>
